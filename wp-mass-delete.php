			...
			<table class="widefat">
				<tr valign="top">
					...
					<td align="left"><input type="text" name="start_date" value=""
						size="10"> - <input type="text" name="end_date" value="" size="10">
					- set the date interval, or leave these fields blank to select all
...
<?php
	...
	?>				
				<tr valign="top">
					...
					&nbsp;&nbsp; <input type="checkbox" name="future"> - scheduled
	...
	if (version_compare ( $wp_version, '2.9', '>=' )) {
		?>				
				<tr valign="top">
					...
					enable the option to completely delete specified the posts.
...
<?php
	...
	?>
			...
			<br />
			<div align="center"><input type="submit" name="delete"
				class="button-primary" value="Delete the posts" />&nbsp;&nbsp;<input
...
<?php
	if (isset ( $_POST ['delete'] )) {
		...
		if ((count ( $type ) || version_compare ( $wp_version, '2.1', '<' )) && count ( $status )) {
			...
			$cnt = count ( $post_ids );
			if ($cnt) {
				echo "<br \><div id=\"message\" class=\"updated fade\"> Deleting count <strong>$cnt<strong> items...";
